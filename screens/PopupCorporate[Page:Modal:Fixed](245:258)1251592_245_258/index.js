...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_299_1016}>
        <View style={styles.View_309_127}>
          <View style={styles.View_I309_127_309_97} />
          <View style={styles.View_I309_127_309_565}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/49df/39cf/f26df1aefca8f0c2a4f8c351e99c3873"
              }}
              style={styles.ImageBackground_I309_127_309_461}
            />
            <View style={styles.View_I309_127_309_462}>
              <View style={styles.View_I309_127_309_463} />
              <View style={styles.View_I309_127_309_464} />
            </View>
          </View>
        </View>
        <View style={styles.View_299_1017}>
          <ImageBackground
            source={{
              uri:
                "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/cf2f/b2d8/88b432f4435dd128381919008c5ad902"
            }}
            style={styles.ImageBackground_299_1018}
          />
          <View style={styles.View_299_1019}>
            <View style={styles.View_299_1020} />
            <View style={styles.View_299_1021} />
            <View style={styles.View_299_1022} />
          </View>
        </View>
        <View style={styles.View_299_1023}>
          <View style={styles.View_299_1024}>
            <Text style={styles.Text_299_1024}>Numéro d’abonnement</Text>
          </View>
        </View>
      </View>
    </ScrollView>
...
const styles = StyleSheet.create({
  ...
  ImageBackground_I309_127_309_461: {
    width: wp("8.51063829787234%"),
    height: hp("11.03448275862069%"),
    top: hp("0%"),
    marginLeft: 0,
