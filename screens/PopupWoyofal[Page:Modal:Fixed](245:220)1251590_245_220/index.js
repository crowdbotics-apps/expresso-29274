...
export class Blank extends React.Component {
  ...
  render = () => (
    ...
    >
      ...
      <View style={styles.View_299_1000}>
        <View style={styles.View_309_120}>
          <View style={styles.View_I309_120_309_97} />
          <View style={styles.View_I309_120_309_565}>
            <ImageBackground
              source={{
                uri:
                  "https://s3-us-west-2.amazonaws.com/figma-alpha-api/img/49df/39cf/f26df1aefca8f0c2a4f8c351e99c3873"
              }}
              style={styles.ImageBackground_I309_120_309_461}
            />
            <View style={styles.View_I309_120_309_462}>
              <View style={styles.View_I309_120_309_463} />
              <View style={styles.View_I309_120_309_464} />
            </View>
          </View>
        </View>
        <View style={styles.View_245_312}>
          <View style={styles.View_245_313}>
            <Text style={styles.Text_245_313}>Mamadou …</Text>
          </View>
        </View>
        <View style={styles.View_245_314}>
          <View style={styles.View_245_315}>
            <Text style={styles.Text_245_315}>Cheikh ka</Text>
          </View>
        </View>
        <View style={styles.View_245_316}>
          <View style={styles.View_245_317}>
            <Text style={styles.Text_245_317}>Aliou Faye</Text>
          </View>
        </View>
        <View style={styles.View_245_318}>
          <View style={styles.View_245_319}>
            <ImageBackground
              ...
              style={styles.ImageBackground_245_320}
            />
          ...
          <View style={styles.View_245_325}>
            <View style={styles.View_245_326}>
              <Text style={styles.Text_245_326}>Numéro de la carte</Text>
            </View>
          </View>
        </View>
        <View style={styles.View_245_327}>
          <Text style={styles.Text_245_327}>Cartes sauvegarder</Text>
        </View>
      </View>
    </ScrollView>
  )
...
const styles = StyleSheet.create({
  ...
  ImageBackground_I309_120_309_461: {
    width: wp("8.51063829787234%"),
    height: hp("11.03448275862069%"),
    top: hp("0%"),
    marginLeft: 0,
  ...
  View_245_326: {
    width: wp("35.90425531914894%"),
    minWidth: wp("35.90425531914894%"),
    marginLeft: 0,
    marginTop: 0,
    position: "absolute",
